        ...
        <ProjectSection id="step-2" title="Step 2: Routing" onImageClick={setSelectedImage}>
            ...
            <div className="space-y-6">
              <div className="gradient-card p-4 sm:p-6 rounded-lg border border-border">
                ...
                <p className="text-xs text-muted-foreground sm:text-xs md:text-xs lg:text-xs mb-2">The part of the Cloudformation code that creates the IGW, NAT Gateway and Route Tables as discussed above<br/>
